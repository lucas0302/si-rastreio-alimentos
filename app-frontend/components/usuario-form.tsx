...
export function UsuarioForm({ onCancel, onSuccess }: UsuarioFormProps = {}) {
  ...
  if (isSuccess) {
    return (
      <div className="flex w-full justify-center">
        <Card className="w-full max-w-xl rounded-3xl border border-gray-200 shadow-sm text-center">
          <CardHeader>
          ...
          <CardContent className="space-y-6 pb-10">
            <div className="space-y-2">
              ...
              <p className="text-gray-600">Usuario adicionado com sucesso.</p>
            </div>
            <Button
              onClick={handleRegisterAnother}
              className="h-11 w-full rounded-full bg-yellow-400 text-black transition-colors hover:bg-yellow-500"
            >
  ...
  return (
    <div className="flex w-full justify-center px-8 py-10">
      <Card className="w-full max-w-4xl rounded-[28px] border border-gray-300 bg-white shadow-sm">
